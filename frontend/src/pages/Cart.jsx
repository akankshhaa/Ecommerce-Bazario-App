...
const Cart = () => {
  ...
  useEffect(() => {
    ...
    // Loop through cartItems  add items to the tempData array
    ...
    // Set the state with the updated cart data
        ...
        <div className="w-full sm:w-[450px]">
          ...
          <div className="w-full text-end">
            <button
              ...
              className="bg-black text-white text-sm my-8 px-8 py-3 hover:bg-red-500"
            >
              PROCEED TO CHECKOUT
            </button>
          </div>
